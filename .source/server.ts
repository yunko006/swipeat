...
export const docs = await create.docs("docs", "content\docs", {"meta.json": __fd_glob_0, "ia/meta.json": __fd_glob_1, "idee/meta.json": __fd_glob_2, }, {"hello.md": __fd_glob_3, "ia/ai-extraction-examples.md": __fd_glob_4, });